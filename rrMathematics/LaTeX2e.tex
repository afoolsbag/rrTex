...
依赖 \pkg{xcolor} 宏包提供颜色支持：

\subsubsection{\pkg{color} 宏包颜色}
...
美国数学协会（American Mathematical Society）提供  \AmS 宏集以扩展 \LaTeX 公式排版，其核心是 \pkg{amsmath} 宏包，对多行公式的排版提供了有力的支持．
此外，\pkg{amsfonts} 宏包以及基于它的 \textsf{amssymb} 宏包提供了丰富的数学符号；\pkg{amsthm} 宏包扩展了 \LaTeX 定理证明格式．
