...
\begin{table}[h]
	\centering
	{
		...
		\begin{tabular}{l l l l l}
			\hline
			\rccard{black}          & \rccard{red}         & \rccard{green}        & \rccard{blue}        &                         \\
			\rccard{white}          & \rccard{cyan}        & \rccard{magenta}      & \rccard{yellow}      &                         \\
			\hline
			\rccard{darkgray}       & \rccard{gray}        & \rccard{lightgray}    &                      &                         \\
			\rccard{brown}          & \rccard{olive}       & \rccard{orange}       & \rccard{lime}        &                         \\
			\rccard{purple}         & \rccard{teal}        & \rccard{violet}       & \rccard{pink}        &                         \\
			\hline
			\rccard{Apricot}        & \rccard{Cyan}        & \rccard{Mahogany}     & \rccard{ProcessBlue} & \rccard{SpringGreen}    \\
			\rccard{Aquamarine}     & \rccard{Dandelion}   & \rccard{Maroon}       & \rccard{Purple}      & \rccard{Tan}            \\
			\rccard{Bittersweet}    & \rccard{DarkOrchid}  & \rccard{Melon}        & \rccard{RawSienna}   & \rccard{TealBlue}       \\
			\rccard{Black}          & \rccard{Emerald}     & \rccard{MidnightBlue} & \rccard{Red}         & \rccard{Thistle}        \\
			\rccard{Blue}           & \rccard{ForestGreen} & \rccard{Mulberry}     & \rccard{RedOrange}   & \rccard{Turquoise}      \\
			\rccard{BlueGreen}      & \rccard{Fuchsia}     & \rccard{NavyBlue}     & \rccard{RedViolet}   & \rccard{Violet}         \\
			\rccard{BlueViolet}     & \rccard{Goldenrod}   & \rccard{OliveGreen}   & \rccard{Rhodamine}   & \rccard{VioletRed}      \\
			\rccard{BrickRed}       & \rccard{Gray}        & \rccard{Orange}       & \rccard{RoyalBlue}   & \rccard{White}          \\
			\rccard{Brown}          & \rccard{Green}       & \rccard{OrangeRed}    & \rccard{RoyalPurple} & \rccard{WildStrawberry} \\
			\rccard{BurntOrange}    & \rccard{GreenYellow} & \rccard{Orchid}       & \rccard{RubineRed}   & \rccard{Yellow}         \\
